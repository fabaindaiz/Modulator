...
public class cameraUtil {
    ...
    public static void downloadResourcePack(Modulator plugin) {
        File destLocation = new File(plugin.getDataFolder() + "/resource-packs/1_16_4/");
        File fileLocation = new File(plugin.getDataFolder() + "/resource-packs/1_16_4.zip");
        try (BufferedInputStream in = new BufferedInputStream(new URL("https://github.com/Cup0fCode/resource-packs/raw/main/1_16_4.zip").openStream());
            ...
            cameraUtil.unzip(fileLocation, plugin.getDataFolder() + "/resource-packs/1_16_4/");
            fileLocation.delete();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void loadColors(Map<Material, Color> blocksMap) {

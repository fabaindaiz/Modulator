...
public class democracyCommand implements CommandExecutor {
    ...
    protected democracyCommand(Modulator modulator) {

        this.plugin = modulator;
        this.lang = modulator.getConfiguration().getLang();
        this.enabled = plugin.getConfiguration().getConfig().getBoolean("democracy.enable");
        this.noname = plugin.getConfiguration().getConfig().getBoolean("democracy.noname");

...
public class lotteryCommand implements CommandExecutor {
    ...
    protected lotteryCommand(Modulator modulator, lotteryStorage storage) {

        this.plugin = modulator;
        this.lang = modulator.getConfiguration().getLang();
        this.enabled = plugin.getConfiguration().getConfig().getBoolean("lottery.enable");
        this.usevault = plugin.getConfiguration().getConfig().getBoolean("lottery.usevault");
        this.price = plugin.getConfiguration().getConfig().getInt("lottery.pricelottery");
        this.collect = plugin.getConfiguration().getConfig().getInt("lottery.collect");
